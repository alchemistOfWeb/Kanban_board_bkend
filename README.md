...
* [x] Задачу можно перемещать по спискам(тем самым устанавливая статус) с помощью следующего запроса
...
* [x] Смена статуса реализована с помощью todolists Можно менять статус задачи, ставя ей определённый todolist.
    [PATCH]  /api_v1/tasks/{id}/ 
    ```json
        {
            "todolist": todolist_id
...
### TodoLists
Списки которым присваиваются задачи в зависимости от их статуса.
